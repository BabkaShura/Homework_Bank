...
- **`read_transactions_csv`**  
  Считывает из файла в формате .csv список транзакций и возвращает их в виде словаря (dict).

- **`read_transactions_excel`**  
  Считывает из файла в формате .xlsx список транзакций и возвращает их в виде словаря (dict).
